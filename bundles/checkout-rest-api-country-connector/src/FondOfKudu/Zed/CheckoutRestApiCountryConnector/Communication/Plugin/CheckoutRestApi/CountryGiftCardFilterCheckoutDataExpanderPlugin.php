 ...
 */
class CountryGiftCardFilterCheckoutDataExpanderPlugin extends AbstractPlugin implements CheckoutDataExpanderPluginInterface
{
    /**
    ...
    public function expandCheckoutData(
        ...
        return $this->getFacade()->expandCheckoutDataWithGiftCardFilteredCountries(
            $restCheckoutDataTransfer,
