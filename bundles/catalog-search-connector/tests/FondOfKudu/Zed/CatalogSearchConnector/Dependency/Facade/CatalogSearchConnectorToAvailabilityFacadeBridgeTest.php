...
class CatalogSearchConnectorToAvailabilityFacadeBridgeTest extends Unit
{
    /**
    ...
    /**
     * @var \FondOfKudu\Zed\CatalogSearchConnector\Dependency\Facade\CatalogSearchConnectorToAvailabilityFacadeBridge
     */
    protected CatalogSearchConnectorToAvailabilityFacadeBridge $bridge;
    ...
    protected function _before(): void
    {
        ...
        $this->bridge = new CatalogSearchConnectorToAvailabilityFacadeBridge($this->availabilityFacadeMock);
    }
